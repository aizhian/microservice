...
public class User implements UserDetails {
    ...
    public User(String username,String tel,String email, String password, Collection<? extends GrantedAuthority> authorities) {
        this(username,tel,email, password,true, true, true, true, authorities);
    }

    public User(String username,String tel,String email, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities) {
